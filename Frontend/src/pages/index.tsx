    ...
    <div className="w-full flex flex-col gap-4">
      <div className="max-w-7xl mx-auto grid grid-cols-2 gap-8 items-center">
        <div>
          ...
          <div className="flex justify-center mt-8">
            <button className="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg px-7 py-4 text-center inline-flex items-center text-lg">
              Learn More
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="rtl:rotate-180 w-6 h-6 ms-2">
                <path strokeLinecap="round" strokeLinejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
              </svg>
            </button>
            <button className="text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg px-7 py-4 text-center inline-flex items-center text-lg ms-4">
              Get Started
        ...
        <div className="bg-gray-900 rounded">
          <div className="w-full min-h-14 bg-gray-800 flex items-center gap-1 rounded-t pr-2">
            <input type="text" placeholder="Search for products or stalls" className="w-full h-full bg-gray-800 text-white px-4 py-2" />
            <button className="text-white bg-gray-800 hover:bg-gray-900 px-4 py-2 rounded active:bg-gray-800 active:transform active:scale-95">
          ...
          <ul className="w-full p-4 h-[380px] overflow-y-auto rounded-b flex flex-col gap-4">
            <li className="flex gap-4">
              ...
              <div>
                <h2 className="text-white text-lg font-semibold">Rokomari.com</h2>
            ...
            <li className="flex gap-4">
              ...
              <div>
                <h2 className="text-white text-lg font-semibold">Bayt Al Hikmah</h2>
            ...
            <li className="flex gap-4">
              ...
              <div>
                <h2 className="text-white text-lg font-semibold">Daraz</h2>
            ...
            <li className="flex gap-4">
              ...
              <div>
                <h2 className="text-white text-lg font-semibold">Nagad</h2>
